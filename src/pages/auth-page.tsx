...
const storeImage = "https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3";
const adminPortalImage = "https://images.unsplash.com/photo-1441986300917-64674bd600d8";
					...
					<div className="w-full max-w-md">
						<div className="text-center mb-8">
							<div className="flex justify-center mb-2">
								<img src={dashLogo} alt="DASH Logo" className="h-24 w-auto" />
							</div>
							{isAdminLogin ? (
								...
								<Form {...loginForm}>
									<form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4">
										...
										<Button
											type="submit"
											className={`w-full ${
												isAdminLogin ? "bg-[#D4AF37] hover:bg-[#D4AF37]/90" : "bg-black hover:bg-[#D4AF37]"
											} text-white`}
				...
				<div className="hidden md:block bg-black relative overflow-hidden">
					{isAdminLogin ? (
						<>
							...
							<div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8">
								...
								<p className="text-center max-w-md mb-6">
									Access the administrative dashboard to manage products, track orders, and oversee all
									aspects of the DASH e-commerce platform.
								</p>
						...
						<>
							...
							<img src={storeImage} alt="DASH Store Interior" className="w-full h-full object-cover" />
							...
							<div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8">
								...
								<p className="text-center max-w-md mb-6">
									Join DASH to discover exclusive luxury fashion, track your orders, and enjoy personalized
